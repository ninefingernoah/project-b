public class Reservation
{
    ...
    public Reservation(string reservationNumber, Flight flight, User user, string email, double price, List<Passenger> passengers, DateTime reservationDate, DateTime madeOn) {
